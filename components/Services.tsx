...
const ServiceCard: React.FC<{ service: Service }> = ({ service }) => {
    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 text-left border border-gray-100 transform hover:-translate-y-2 flex flex-col">
            <div className="mb-4">
