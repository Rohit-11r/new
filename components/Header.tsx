...
const Header: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-24 flex justify-center items-start pt-4 z-50">
        <header className={`w-[95%] max-w-7xl transition-all duration-300 bg-header-bg/80 backdrop-blur-md shadow-lg ${isOpen ? 'rounded-3xl' : 'rounded-full'}`}>
